...
void Time_Change_Process_InWorkout(short TimeChangeValue){
    ...
    if(NowPeriodLimitValue_Temp / RestOfPeriod_Temp >= 10){   //>= 10
...
void Random_Init(){
    ...
    Template_To_Table_96(Random_Profile_Template);
    /*
    for(unsigned char i = 0;i < Program_Data.Template_Table_Num; i++){
...
void CrossCountry_Init(){
    ...
    Template_To_Table_96(CrossCountry_Profile_Template);
    /*
    for(unsigned char i = 0;i < Program_Data.Template_Table_Num; i++){
...
void WeightLoss_Init(){
    ...
    Template_To_Table_96(WeightLoss_Profile_Template);
    /*
    for(unsigned char i = 0;i < Program_Data.Template_Table_Num; i++){
...
void Interval_1_1_Init(){
    ...
    Template_To_Table_96(Interval_1_1_Template);
...
void Interval_1_2_Init(){
    ...
    Template_To_Table_96(Interval_1_2_Template);
